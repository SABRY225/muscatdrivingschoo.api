...
const sendLessonEmail = async (email, lang, message, type = "start") => {
  try {
    // تحديد عنوان الرسالة حسب النوع واللغة
      ...
      lang === "ar"
        ? `<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #ffffff;">
            <div style="text-align: center; padding: 10px 0; background-color: #f4f4f4; border-bottom: 1px solid #ddd;">
                <h1 style="margin: 0; font-size: 20px;">إشعار من منصة مسقط لتعليم قيادة السيارات</h1>
            </div>
        ...
        : `<div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #ffffff;">
            <div style="text-align: center; padding: 10px 0; background-color: #f4f4f4; border-bottom: 1px solid #ddd;">
                <h1 style="margin: 0; font-size: 20px;">Notification from Muscat Driving School Platform</h1>
            </div>
