const generateConfirmWhatsappBody = (language, code) => {
  return language === "en"
...
const generateWelcomeWhatsappBody = (language, name) => {
  return language === "en"
    ? `
...
const generateChargeConfirmationWhatsappBody = (language, name, price, currency) => {
  return language === "en"
...
const generateSessionConfirmationWhatsappBody = (
  language,
  studentName,
  teacherName,
  date,
...
module.exports = {
  generateConfirmWhatsappBody,
  generateWelcomeWhatsappBody,
  generateChargeConfirmationWhatsappBody,
  generateSessionConfirmationWhatsappBody,
