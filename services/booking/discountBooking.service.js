const { createStudentDiscount } = require("../shared/createEntities.service");
...
exports.book = async (data) => {
  ...
  if (typeOfPayment === "thawani") {
    return await handleThawaniPayment(data, price, createStudentDiscount);
  } else if (typeOfPayment === "wallet") {
    return await handleWalletPayment(data, price, createStudentDiscount, "dicount_booking");
  }else if(typeOfPayment === "points"){
    return await handlePointsPayment(data, price, createStudentDiscount, "dicount_booking");
  }
};